...
urlpatterns = [
    ...
    path('dashboard-motorist/ticket-history', views.m_ticket_history, name='m_ticket-history'),
    path('dashboard-official/ticket-history', views.o_ticket_history, name='o_ticket-history'),
